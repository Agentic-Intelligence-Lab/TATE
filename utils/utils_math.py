...
# Pretty labels for the remaining preprocess stages. Any @time_it-decorated
# function not listed here keeps the plain banner.
_PREPROCESS_STAGES = {
    "preprocess_wilor_hands": "WiLoR hand / EEF reconstruction",
}
